...
const template = require( "../../templates/gallery-banner-ad.html" );





export class GalleryBannerAd {
    ...
    constructor(adData: any) {
        ...
        this.container.className    = "sup-main-container large";
        ...
        const img = this.data.images.filter( (i: any) => i.position === AdImagePosition.GALLERY_BANNER )[0];
    ...
    private registerEventListeners(): void {
        ...
        this.container.addEventListener( "click", () => {
            ...
            this.connection.registerAdClick( this.data._id, AdImagePosition.GALLERY_BANNER );
        });
