...
export class HTMLHelper {
    ...
    /**
     * Returns the Y scroll position on the window
     * @return {number}
     */
    public static getWindowYscroll() {
    ...
    /**
     * Returns the scroll percentage on the page
     * @return {number}
     */
    public static getScrollPercentage() {
        return (
            (HTMLHelper.getWindowYscroll() + HTMLHelper.getWindowHeight()) / HTMLHelper.getDocumentHeight()
        ) * 100;
    }
}
